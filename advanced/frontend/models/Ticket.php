...
class Ticket extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tick_startDate', 'tick_description', 'tick_timelimit', 'ticket_type_id', 'department_id', 'room_room_no', 'user_idCreated'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'user_idCreated' => 'User Id Created',
            'user_id1Assigned' => 'User Id1 Assigned',
            'user_id2closed' => 'User Id2closed',
        ];
    }
